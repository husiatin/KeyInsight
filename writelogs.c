...
void writeResultsToLog(float avgKeyPressIntervals, float avgKeyPresses, float avgEnterPresses, float avgBackspacePresses, float avgClicks, float clickDifference) {
    SYSTEMTIME lt;
